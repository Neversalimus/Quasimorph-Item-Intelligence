...
Write-Host 'Item Intelligence v1.7.42.8 - Stable Release' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.8 (StableRelease17428).' -ForegroundColor Cyan
Write-Host ''
