...
Write-Host 'Item Intelligence v1.7.42.6-test2 - Quasimorph 1.0.4.582 compatibility + eight languages' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.6-test2 (Compat104582Test02).' -ForegroundColor Cyan
Write-Host ''
