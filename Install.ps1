...
Write-Host 'Item Intelligence v1.7.42.7-test5 - Browser readability' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.7-test5 (Readability17427Test05).' -ForegroundColor Cyan
Write-Host ''
