...
Write-Host 'Item Intelligence v1.7.42.5-test3 - Large UI + Zoom + Implant sources + Languages' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.5-test3 (LargeUiLanguagesTest03).' -ForegroundColor Cyan
Write-Host ''
