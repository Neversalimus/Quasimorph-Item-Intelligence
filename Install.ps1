...
Write-Host 'Item Intelligence v1.7.42.5-test2 - Implant sources + Languages + MCM' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.5-test2 (ImplantBodyLanguagesTest02).' -ForegroundColor Cyan
Write-Host ''
