...
Write-Host 'Item Intelligence v1.7.42.6-test1 - Spanish + Brazilian Portuguese + French' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.6-test1 (LatinLanguagesTest01).' -ForegroundColor Cyan
Write-Host ''
