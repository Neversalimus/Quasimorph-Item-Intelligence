...
Write-Host 'Item Intelligence v1.7.42.5-test4 - Large UI + Zoom + Implant sources + Languages' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.5-test4 (LargeUiLanguagesTest04).' -ForegroundColor Cyan
Write-Host ''
