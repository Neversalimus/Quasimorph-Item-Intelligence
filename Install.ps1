...
Write-Host 'Item Intelligence v1.7.42.7-test1 - Browser readability' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.7-test1 (Readability17427Test01).' -ForegroundColor Cyan
Write-Host ''
