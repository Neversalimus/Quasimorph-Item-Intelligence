...
Write-Host 'Item Intelligence v1.7.42.7-test4 - Browser readability' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.7-test4 (Readability17427Test04).' -ForegroundColor Cyan
Write-Host ''
