...
Write-Host 'Item Intelligence v1.7.42.7 - Stable Release' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.7 (StableRelease17427).' -ForegroundColor Cyan
Write-Host ''
