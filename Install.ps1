...
Write-Host 'Item Intelligence v1.7.42.5-test1 - Languages + MCM' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.5-test1 (LanguagesMcmTest01).' -ForegroundColor Cyan
Write-Host ''
