...
Write-Host 'Item Intelligence v1.7.42.6 - Stable Release' -ForegroundColor Cyan
...
Write-Host '[ItemIntelligence] ACTIVE VERSION 1.7.42.6 (StableRelease17426).' -ForegroundColor Cyan
Write-Host ''
