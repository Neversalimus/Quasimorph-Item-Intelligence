...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.8";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('StableRelease17428',[StringComparison]::Ordinal) -lt 0) {
