...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.7-test2";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('Readability17427Test02',[StringComparison]::Ordinal) -lt 0) {
