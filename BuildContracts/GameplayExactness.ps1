...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.7-test1";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('Readability17427Test01',[StringComparison]::Ordinal) -lt 0) {
