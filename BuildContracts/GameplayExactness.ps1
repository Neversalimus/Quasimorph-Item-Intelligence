...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.6-test2";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('Compat104582Test02',[StringComparison]::Ordinal) -lt 0) {
