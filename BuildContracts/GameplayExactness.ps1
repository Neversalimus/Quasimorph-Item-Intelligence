...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5-test2";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('ImplantBodyLanguagesTest02',[StringComparison]::Ordinal) -lt 0) {
