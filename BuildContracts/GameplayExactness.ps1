...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.6";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('StableRelease17426',[StringComparison]::Ordinal) -lt 0) {
