...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5-test4";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('LargeUiLanguagesTest04',[StringComparison]::Ordinal) -lt 0) {
