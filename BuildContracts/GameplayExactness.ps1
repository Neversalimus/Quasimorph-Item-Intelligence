...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.6-test1";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('LatinLanguagesTest01',[StringComparison]::Ordinal) -lt 0) {
