...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5-test5";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('McmFontLanguagesTest05',[StringComparison]::Ordinal) -lt 0) {
