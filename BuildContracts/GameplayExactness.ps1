...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5-test3";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('LargeUiLanguagesTest03',[StringComparison]::Ordinal) -lt 0) {
