...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5-test1";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('LanguagesMcmTest01',[StringComparison]::Ordinal) -lt 0) {
