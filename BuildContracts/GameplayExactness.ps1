...
if ($runtimeText.IndexOf('public const string Version = "1.7.42.5";',[StringComparison]::Ordinal) -lt 0 -or
    $runtimeText.IndexOf('StableRelease17425',[StringComparison]::Ordinal) -lt 0) {
